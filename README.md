# André Boilerplate II: Webpack + babel
...
1. Clone this repository into a new project folder (replace `[project name]` with the new project's name)

   ```
   git clone git@github.com:andreglock/andre-boilerplate-II.git [project name]
   ```
...
Should contain a brief description of the project, feel free to delete this guide or rename it to add your own description.
...
This folder will contain my built project, ready to be deployed online.
